  ...
  return (
    <div className='mr-3 w-64 flex-shrink-0 rounded bg-gray-200 p-1.5'>
        ...
        {book?.id === 0 || isEditing ? (
          <div className='p-1.5'>
            ...
            <button
              ...
              className='float-left text-red-400 hover:text-pink-600'
            >
              Remove
            </button>
            <button
              onClick={changeBookTitle}
              className='float-right text-blue-400 hover:text-sky-600'
            >
              Save
            </button>
          </div>
      ...
      <button
        ...
        className='float-right mt-2 rounded-full bg-blue-400 px-4 py-1 font-medium text-white hover:bg-sky-500'
      >
        + Add Mark
      </button>
    </div>
